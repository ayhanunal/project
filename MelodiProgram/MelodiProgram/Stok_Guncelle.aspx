<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stok_Guncelle.aspx.cs" Inherits="MelodiProgram.Stok_Guncelle" %>
			...
			<div class="wrap-login100">
					...
					<table class="auto-style7" align="center">
						...
						<table border="0" align="center">
							...
							<tr>
								<td>
									<asp:Button ID="Button1" runat="server" Text="Güncelle" Width="78px" OnClick="Button1_Click" />
								</td>
							</tr>
