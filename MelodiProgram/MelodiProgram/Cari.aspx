<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cari.aspx.cs" Inherits="MelodiProgram.Cari" %>
		...
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<table class="auto-style7" align="center" border="0">
						...
						<tr><td class="auto-style11"><b>Cari Kart Ekle</b></td><td class="auto-style12"></td><td class="auto-style14"></td><td class="auto-style12"></td><td class="auto-style12"></td><td class="auto-style12"></td>
						...
						<td class="auto-style10">
							<asp:TextBox ID="cari_kod" runat="server" Height="27px" Width="150px"></asp:TextBox>
							</td>
						...
						<table align="center">
							...
							<tr>
								<td class="auto-style4"><asp:Button ID="cari_kaydet" runat="server" Text="Kaydet" Width="85px" OnClick="cari_kaydet_Click" />
								</td>
